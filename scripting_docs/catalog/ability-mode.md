...
- `Cost$`: TODO: Describe this parameter.
  Observed values: `4 U U R`, `PayEnergy<8> Exile<1/CARDNAME>`, `SubCounter<12/LOYALTY>`, `T SubCounter<3/CHARGE>`, `T SubCounter<1/EON> Return<1/CARDNAME>`, `SubCounter<All/P1P1>`, `SubCounter<10/LOYALTY>`, `SubCounter<9/LOYALTY>`, `Waterbend<20>`, `T Sac<5/Artifact>`
...
- `IsCurse$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Planeswalker.YouCtrl+Oko`, `Creature.YouCtrl`, `Card.Self+!Spirit`, `Card.Self+!withDefender`
...
- `Ultimate$`: TODO: Describe this parameter.
  Observed values: `True`
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Card.YouOwn+sharesCardTypeWith Remembered`, `Creature.Elf+YouCtrl`, `Creature.YouCtrl`, `Creature.OppCtrl`, `Vehicle.YouCtrl`, `Creature`, `Card.nonLand+YouOwn`, `Creature.Damaged`, `Creature.OppCtrl,Planeswalker.OppCtrl`, `Sorcery.YouOwn,Instant.YouOwn`
- `ValidTgts$`: TODO: Describe this parameter.
  Observed values: `Opponent`, `Player`
...
- `Cost$`: TODO: Describe this parameter.
  Observed values: `3 T Exile<1/CARDNAME>`, `1 W U`, `T`, `2 B`, `ExileAnyGrave<1/Card.TriggeredNewCard>`, `1 U T`, `B R G T`, `2 U Discard<2/Card>`, `4 W`, `U Sac<1/CARDNAME>`
- `CostDesc$`: TODO: Describe this parameter.
...
- `IsCurse$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Creature.YouOwn+Above`, `Swamp.YouCtrl`, `Card.Self+tapped`, `Enchantment.YouOwn`, `Aura.Attached`, `Creature.Legendary+YouCtrl`, `Permanent.Snow+YouCtrl`, `Permanent.White+YouCtrl`, `Card.YouOwn+named1996 World Champion`, `Permanent.YouOwn`
- `LeaveBattlefield$`: TODO: Describe this parameter.
  Observed values: `Exile`
...
- `Chooser$`: TODO: Describe this parameter.
  Observed values: `Opponent`
- `Cost$`: TODO: Describe this parameter.
  Observed values: `4 T`, `X T`, `1 T Sac<1/CARDNAME>`, `1 G T`, `2 Sac<2/Artifact>`, `T Sac<1/Artifact>`, `1 Sac<1/CARDNAME>`, `2 T`, `1 B Sac<1/Creature>`, `1 ExileFromGrave<1/Instant;Sorcery>`
- `CostDesc$`: TODO: Describe this parameter.
...
- `Cost$`: TODO: Describe this parameter.
  Observed values: `SubCounter<4/LOYALTY>`, `Sac<1/CARDNAME>`, `W`, `SubCounter<X/LOYALTY>`, `Discard<1/Card>`, `T PayLife<1>`, `3 Sac<1/CARDNAME>`, `1`, `1 B T`, `T Sac<1/CARDNAME>`
- `Defined$`: TODO: Describe this parameter.
...
- `Ultimate$`: TODO: Describe this parameter.
  Observed values: `True`
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Creature`, `Creature.!IsRemembered+ControlledBy TargetedController`, `Creature.ControlledBy TargetedOrController`, `Creature.withFlying`, `Creature.!IsRemembered`, `Creature.StrictlyOther`, `Creature.withoutFlying`, `Creature.OppCtrl`, `Creature.ControlledBy TriggeredTarget`, `Creature.YouDontCtrl`
- `ValidDescription$`: TODO: Describe this parameter.
...
- `IsCurse$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Card.Self+attacking`, `Card.powerGE4+Self`, `Card.Self`, `Card.Self+!firstTurnControlled`, `Card.Self+attacking,Card.Self+blocking`, `Card.Self+counters_GE1_P1P1`
- `Max$`: TODO: Describe this parameter.
  Observed values: `5`
- `Min$`: TODO: Describe this parameter.
  Observed values: `0`
...
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Card.IsTriggerRemembered`, `Card.StrictlySelf`, `Card.IsTriggerRemembered+AttachedTo Creature.YouCtrl`
- `Mode$`: TODO: Describe this parameter.
...
- `ValidCard$`: TODO: Describe this parameter.
  Observed values: `Instant,Sorcery`, `Card.IsTriggerRemembered`, `Card.Self`, `Wolf,Werewolf`, `Card.IsTriggerRemembered+YouCtrl`, `Instant.cmcLE4,Sorcery.cmcLE4`, `Card`, `Instant.cmcLE3,Sorcery.cmcLE3`, `Creature`, `Lesson`
...
- `Cost$`: TODO: Describe this parameter.
  Observed values: `PayLife<4>`, `2 T Sac<1/CARDNAME>`, `7 T`, `Sac<1/CARDNAME>`, `W Sac<1/Enchantment>`, `3 T Sac<1/CARDNAME>`, `T Sac<1/Land>`, `B T tapXType<X/Knight>`, `G G T`, `B Sac<1/Creature>`
- `CostDesc$`: TODO: Describe this parameter.
...
- `IsCurse$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Vampire.YouCtrl`, `Card.Artifact+YouCtrl`
- `MaxTotalTargetCMC$`: TODO: Describe this parameter.
  Observed values: `X`
- `ModeCost$`: TODO: Describe this parameter.
...
- `UnlessSwitched$`: TODO: Describe this parameter.
  Observed values: `True`
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Creature.blockingSource,Creature.blockedBySource`, `Forest`, `Land`, `Artifact,Creature,Enchantment`, `Creature.Other`, `Permanent.White`, `Creature`, `Artifact.YouDontCtrl`, `Permanent.!token+setHML`, `Permanent.nonLand`
- `ValidDescription$`: TODO: Describe this parameter.
- `ValidTgts$`: TODO: Describe this parameter.
...
- `ChangeValid$`: TODO: Describe this parameter.
  Observed values: `Card`, `Creature`, `Creature.cmcLE4`, `Card.Knight,Aura,Equipment,Artifact.Legendary`, `Artifact`, `Assassin,Pirate,Vehicle`, `Card.Creature`, `Creature,Land`, `Permanent`, `Aura,Creature,Planeswalker`
...
- `ChangeLater$`: TODO: Describe this parameter.
  Observed values: `True`
- `ChangeValid$`: TODO: Describe this parameter.
  Observed values: `Creature,Enchantment`, `Creature,Land`, `Card.Cleric,Card.Rogue,Card.Warrior,Card.Wizard`, `Card.Angel,Card.Demon,Card.Dragon`, `Card.Warrior,Card.Equipment`, `Card.withFlying,Card.withFirst Strike,Card.withDeathtouch,Card.withHaste,Card.withHexproof,Card.withIndestructible,Card.withLifelink,Card.withMenace,Card.withReach,Card.withTrample,Card.withVigilance`, `Land,Spell.!Aura`
...
- `Spellbook$`: TODO: Describe this parameter.
  Observed values: `Amorphous Axe,Citizen's Crowbar,Cloudsteel Kirin,Conqueror's Flail,Fireshrieker,Fishing Pole,Krovod Haunch,Leech Gauntlet,Lion Sash,Mace of the Valiant,Maul of the Skyclaves,Shield of the Realm,Sigiled Sword of Valeron,Thran Power Suit,Thunder Lasso`, `Boots of Speed,Cliffhaven Kitesail,Colossus Hammer,Dueling Rapier,Spare Dagger,Tormentor's Helm,Goldvein Pick,Jousting Lance,Mask of Immolation,Mirror Shield,Relic Axe,Rogue's Gloves,Scavenged Blade,Shield of the Realm,Ceremonial Knife`, `Arcane Encyclopedia,Daredevil Dragster,Diamond Mare,Filigree Familiar,Fountain of Renewal,Gilded Lotus,Golden Egg,Guild Globe,Heraldic Banner,Honored Heirloom,Key to the City,Prophetic Prism,Stuffed Bear,Treasure Vault,Zephyr Boots`, `Corpse Churn,Corpse Hauler,Courier Bat,Durable Coilbug,Fear of Death,Gorging Vulture,Locked in the Cemetery,Naga Oracle,Necrotic Wound,Obsessive Stitcher,Reassembling Skeleton,Strategic Planning,Unmarked Grave,Wonder`, `Accorder Paladin,Ardent Recruit,Auriok Sunchaser,Blade-Tribe Berserkers,Goblin Gaveleer,Hero of Bladehold,Hero of Oxid Ridge,Mirran Crusader,Oxidda Scrapmelter,Sunspear Shikari,Oxidda Finisher,Barbed Batterfist,Bladehold War-Whip,Dragonwing Glider,Jor Kadeen; the Prevailer`, `Emergence Zone,Radiant Fountain,Scavenger Grounds,Boseiju; Who Endures,Gingerbread Cabin,Khalni Garden,Memorial to Unity,Thriving Grove,Hall of Oracles,Secluded Courtyard,Treasure Vault,Mobilized District,Bonders' Enclave,Roadside Reliquary,Field of Ruin`, `Colossal Plow,Millstone,Whirlermaker,Magistrate's Scepter,Replicating Ring,Raiders' Karve,Weapon Rack,Relic Amulet,Orazca Relic,Fifty Feet of Rope,Pyre of Heroes,Treasure Chest,Leather Armor,Spiked Pit Trap,Gingerbrute`, `Adagia; Windswept Bastion,Evendo; Waking Haven,Kavaron; Memorial World,Susur Secundi; Void Altar,Uthros; Titanic Godcore`, `Angel of Destiny,Resplendent Angel,Angel of Vitality,Righteous Valkyrie,Angel of Invention,Angel of Sanctions,Valkyrie Harbinger,Emancipation Angel,Youthful Valkyrie,Resplendent Marshal,Enduring Angel,Sigardian Savior,Serra Angel,Stalwart Valkyrie,Segovian Angel`, `Bloom Hulk,Contagion Engine,Contagion Clasp,Evolution Sage,Contentious Plan,Flux Channeler,Inexorable Tide,Merfolk Skydiver,Pollenbright Druid,Roalesk; Apex Hybrid,Sword of Truth and Justice,Thrummingbird,Smell Fear,Cankerbloom,Tezzeret's Gambit`
...
- `Cost$`: TODO: Describe this parameter.
  Observed values: `W B G T Sac<1/CARDNAME>`, `2 U SubCounter<1/P1P1>`, `Discard<1/Card>`, `1 Sac<1/CARDNAME>`, `2 T`, `T PayEnergy<50>`, `2 B Sac<1/Creature.Other/another creature>`, `2 Sac<1/CARDNAME>`, `Sac<1/Land>`, `2 U T`
- `CostDesc$`: TODO: Describe this parameter.
...
- `IsCurse$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Creature.YouCtrl+powerGE4`, `Land.YouCtrl`, `Card.Self+attacking`, `Card.YouOwn`, `Card.Self+Blue`, `Card.Self+counters_GE5_OIL`
...
- `Ultimate$`: TODO: Describe this parameter.
  Observed values: `True`
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Creature.!IsRemembered+ControlledBy TargetedController`, `Creature.YouCtrl+counters_GE1_P1P1`, `Dragon.Creature+YouCtrl`, `Dragon.YouCtrl`, `Creature`, `Creature.tapped`
- `ValidDescription$`: TODO: Describe this parameter.
- `ValidTgts$`: TODO: Describe this parameter.
...
- `ConditionZone$`: TODO: Describe this parameter.
  Observed values: `Stack`
- `Cost$`: TODO: Describe this parameter.
  Observed values: `3 T`, `4 T`, `1`, `U`, `2 U`, `SubCounter<7/LOYALTY>`, `SubCounter<6/LOYALTY>`, `5 T`, `XMin1 X T`, `G U T`
- `CostDesc$`: TODO: Describe this parameter.
...
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Planeswalker.Yanggu+YouCtrl`, `Permanent.Green+YouCtrl`
...
- `ConditionZone$`: TODO: Describe this parameter.
  Observed values: `Stack`
- `Cost$`: TODO: Describe this parameter.
  Observed values: `T Sac<1/Creature.Other;Artifact.Other/another creature or artifact>`, `1 B T`, `2 Sac<1/Creature.Other;Blood.token/another creature or a Blood token>`, `3 W B T Sac<1/NICKNAME>`, `T Sac<X/Permanent>`, `5 T`, `Draw<X/You>`, `Sac<1/CARDNAME>`, `7 B T Sac<1/CARDNAME>`, `T 2 B`
- `CostDesc$`: TODO: Describe this parameter.
...
- `IsCurse$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Planeswalker.Liliana+YouCtrl`, `Permanent.Black+YouCtrl`, `Creature.YouOwn`
- `LifeAmount$`: TODO: Describe this parameter.
...
- `SorcerySpeed$`: TODO: Describe this parameter.
  Observed values: `True`
- `Spellbook$`: TODO: Describe this parameter.
  Observed values: `Spyglass Siren,Staunch Crewmate,Corsair Captain`, `Empty the Warrens,Galvanic Relay,Grapeshot`, `Shivan Dragon,Moonveil Regent,Terror of the Peaks,Leyline Tyrant,Immersturm Predator,Manaform Hellkite,Bone Dragon,Demanding Dragon,Skarrgan Hellkite,Thunderbreak Regent,Black Dragon,Skyship Stalker,Red Dragon`, `Blade Juggler,Body Count,Dead Revels,Drill Bit,Hackrobat,Light Up the Stage,Rafter Demon,Rix Maadi Reveler,Skewer the Critics,Spawn of Mayhem,Spikewheel Acrobat`, `First Little Pig,Second Little Pig,Third Little Pig`, `Gate of the Black Dragon,Gate to Manorborn,Gate to Seatower,Gate to the Citadel,Gate to Tumbledown`, `Goblin Warchief,Goblin Chieftain,Skirk Prospector,Brash Taunter,Wily Goblin,Goblin Trashmaster,Ember Hauler,Relic Robber,Fanatical Firebrand,Goblin Arsonist,Reckless Ringleader,Battle Cry Goblin,Beetleback Chief,Goblin Instigator,Legion Warboss`, `Faith's Fetters,Ritual of Rejuvenation,Invoke the Divine,Inspiring Cleric`, `Hard Evidence,Stifle,Contentious Plan,Suit Up,Befuddle,Majestic Metamorphosis,Hampering Snare,Ghostform,See the Truth,Keep Safe,Teferi's Time Twist,Startle,Flood of Recollection,Choking Tethers,Bury in Books`, `Belligerent Sliver,Bladeback Sliver,Blur Sliver,Bonescythe Sliver,Cleaving Sliver,Cloudshredder Sliver,Diffusion Sliver,Dregscape Sliver,Enduring Sliver,First Sliver's Chosen,Hollowhead Sliver,Lancer Sliver,Lavabelly Sliver,Leeching Sliver,Manaweft Sliver,Predatory Sliver,Scuttling Sliver,Sentinel Sliver,Sliver Hivelord,Spiteful Sliver,Steelform Sliver,Striking Sliver,Tempered Sliver,The First Sliver`
...
- `InstantSpeed$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Swamp.YouCtrl,Mountain.YouCtrl`, `Plains.YouCtrl,Swamp.YouCtrl`, `Creature.YouCtrl+powerGE4`, `Plains.YouCtrl,Island.YouCtrl`, `Creature.Self`, `Island.YouCtrl,Swamp.YouCtrl`, `Forest.YouCtrl,Plains.YouCtrl`, `Card.Self+ThisTurnEntered`, `Dragon.YouCtrl`, `Island.YouCtrl`
- `OpponentTurn$`: TODO: Describe this parameter.
  Observed values: `True`
- `Optional$`: TODO: Describe this parameter.
  Observed values: `True`
...
- `ValidSource$`: TODO: Describe this parameter.
  Observed values: `Permanent.YouCtrl+Other+counters_GE1_P1P1`, `Creature.YouCtrl`, `Creature`
- `ValidTgtDesc$`: TODO: Describe this parameter.
...
- `SubAbility$`: TODO: Describe this parameter.
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Card.nonLand`, `Card.Creature`, `Card.Land+nonBasic`, `Card.nonBasic`, `Card.nonLand+nonCreature`, `Creature`, `Card.Artifact`, `Creature.cmcEQX`, `Creature.ManaCost=Equipped`, `Card.nonLand+nonArtifact`
- `ValidDescription$`: TODO: Describe this parameter.
- `ValidTgts$`: TODO: Describe this parameter.
  Observed values: `Player`
...
- `ValidZone$`: TODO: Describe this parameter.
  Observed values: `Hand`, `Library`, `Exile`, `Hand,Graveyard`, `Graveyard`, `Sideboard`, `Command`, `Graveyard,Hand`, `Graveyard,Exile`, `Hand,Graveyard,Exile`
...
- `TgtPrompt$`: TODO: Describe this parameter.
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Creature.YouCtrl`, `Creature.White+YouCtrl`, `Creature.YouCtrl+Legendary`, `Permanent.YouCtrl`, `Card.Ally+YouCtrl`, `Creature`
- `ValidPlayers$`: TODO: Describe this parameter.
  Observed values: `You`
- `ValidTgts$`: TODO: Describe this parameter.
...
- `IsCurse$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Land.Snow+DefenderCtrl`, `Demon.YouCtrl`, `Card.Self+Creature`, `Card.Self+blocked`, `Card.Self+toughnessGE2`, `Creature.YouCtrl+withFlying`, `Mountain.Snow+YouCtrl`, `Card.powerGE4+Self`, `Creature.blockingSource`, `Creature.withFlying+OppCtrl`
...
- `UnlessSwitched$`: TODO: Describe this parameter.
  Observed values: `True`
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Wizard.YouCtrl`, `Creature.YouCtrl`, `Creature.YouCtrl+StrictlyOther`, `Creature.attacking+Red`, `Creature.attacking+White`, `Creature.token+YouCtrl`, `Creature.attacking`, `Creature.Ally+YouCtrl`, `Creature.Other+YouCtrl+withFlying`, `Creature.Other+YouCtrl+withFirst Strike`
- `ValidTgts$`: TODO: Describe this parameter.
  Observed values: `Opponent`, `Player`
...
- `ConditionZone$`: TODO: Describe this parameter.
  Observed values: `Stack`
- `Cost$`: TODO: Describe this parameter.
  Observed values: `Sac<1/CARDNAME> RevealChosen<Type/creature type>`, `tapXType<2/Artifact;Creature/artifacts and/or creatures>`, `B ExileFromGrave<1/CARDNAME>`, `ExileFromGrave<2/Card>`, `2 G U`, `T`, `PayEnergy<2>`, `2 G G`, `3 U ExileFromGrave<1/CARDNAME>`, `AddCounter<1/LOYALTY>`
- `CostDesc$`: TODO: Describe this parameter.
...
- `IsCurse$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Card.Self+attackingYou`, `Card.canReceiveCounters P1P1`, `Card.Self+ThisTurnEntered`
- `Mandatory$`: TODO: Describe this parameter.
  Observed values: `True`
...
- `Ultimate$`: TODO: Describe this parameter.
  Observed values: `True`
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Creature.YouCtrl+tapped`, `Creature.YouCtrl`, `Creature.Dragon+YouCtrl+StrictlyOther`, `Creature.Legendary+YouCtrl`, `Creature.ChosenCard`, `Cat.YouCtrl`, `Creature.OppCtrl`, `Creature.YouCtrl,Vehicle.YouCtrl`, `Creature.YouCtrl+StrictlyOther`, `Creature.YouCtrl+withModular`
...
- `SubAbility$`: TODO: Describe this parameter.
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Permanent`, `Card.YouOwn+!IsRemembered`, `Creature`, `Card.Self`, `Card.suspended`, `Creature.YouCtrl`, `Land`, `Planeswalker`, `Card.suspended+YouOwn`, `Permanent.ActivePlayerCtrl`
- `ValidZone$`: TODO: Describe this parameter.
  Observed values: `Exile`
...
- `UnlessUpTo$`: TODO: Describe this parameter.
  Observed values: `True`
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Permanent.nonLand+OppCtrl+nonChosenCard`, `Permanent.nonColorless`, `Creature.nonChosenCard`, `Card.EnchantedBy`, `Creature.StrictlyOther`, `Permanent.nonChosenCard`, `Permanent.nonLand+nonChosenCard`, `Permanent.!token+setARN+Other`, `Card.IsRemembered`, `Dragon.YouCtrl`
- `ValidTgts$`: TODO: Describe this parameter.
...
- `FaceDownToughness$`: TODO: Describe this parameter.
  Observed values: `2`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Card.Vampire+YouCtrl`, `Card.canBeTurnedFaceUp+faceDown`, `Permanent.YouCtrl`, `Card.Self+counters_EQ0_TIME`
- `Mandatory$`: TODO: Describe this parameter.
  Observed values: `True`
- `MinAmount$`: TODO: Describe this parameter.
  Observed values: `0`
...
- `IsCurse$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Creature.YouCtrl+withFlying`, `Card.Self+attacking`, `Land.YouCtrl`
- `OpponentTurn$`: TODO: Describe this parameter.
  Observed values: `True`
- `Planeswalker$`: TODO: Describe this parameter.
  Observed values: `True`
...
- `UnlessResolveSubs$`: TODO: Describe this parameter.
  Observed values: `WhenNotPaid`
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Creature.withoutFlying`, `Spirit`, `Creature.nonSpirit`, `Creature.untapped+!attackedThisTurn+ActivePlayerCtrl`, `Creature.Legendary`, `Creature`, `Creature.IsRemembered`, `Land.IsRemembered`, `Creature.nonWhite`, `Creature.OppCtrl+toughnessLE2`
- `ValidTgts$`: TODO: Describe this parameter.
...
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Permanent.Snow+YouCtrl`, `Card.EquippedBy`
- `PresentCompare$`: TODO: Describe this parameter.
  Observed values: `GE4`
- `SpellDescription$`: TODO: Describe this parameter.
- `SubAbility$`: TODO: Describe this parameter.
...
- `Cost$`: TODO: Describe this parameter.
  Observed values: `6 T`, `1 W B G T Sac<1/CARDNAME>`, `2 U`, `PayEnergy<2>`, `SubCounter<8/LOYALTY>`, `SubCounter<6/LOYALTY>`, `AddCounter<0/LOYALTY>`, `AddCounter<1/LOYALTY>`, `SubCounter<2/LOYALTY>`, `Sac<1/CARDNAME>`
- `CostDesc$`: TODO: Describe this parameter.
...
- `ImprintTokens$`: TODO: Describe this parameter.
  Observed values: `True`
- `IsPresent$`: TODO: Describe this parameter.
  Observed values: `Creature.YouCtrl+FoughtThisTurn`, `Creature.attackingYou`, `Creature.YouCtrl`, `Creature.YouCtrl+attacking+modified`, `Enchantment.YouCtrl`, `Card.Self+counters_GE4_QUEST`, `Sliver.YouCtrl`
- `LockInText$`: TODO: Describe this parameter.
  Observed values: `True`
...
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Land.!token+RememberedPlayerCtrl`, `Creature`, `Permanent`, `Creature.RememberedPlayerCtrl`, `Creature.withoutFlying+RememberedPlayerCtrl`, `Creature.attacking+YouCtrl`
- `ValidTgts$`: TODO: Describe this parameter.
  Observed values: `Opponent`, `Player`
- `Zone$`: TODO: Describe this parameter.
...
- `UnlessSwitched$`: TODO: Describe this parameter.
  Observed values: `True`
- `ValidCards$`: TODO: Describe this parameter.
  Observed values: `Creature.YouCtrl`, `Creature.YouCtrl+StrictlyOther`, `Creature.modified+YouCtrl`, `Creature,Land`, `Creature.White+YouCtrl`, `Land.YouCtrl`, `Creature`, `Artifact`, `Creature.tapped`, `Creature.Other+YouCtrl`
- `ValidTgts$`: TODO: Describe this parameter.
  Observed values: `Opponent`, `Player`
